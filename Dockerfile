...
# Copy source code
ADD Wine_Quality_Prediction.py .
...
ENTRYPOINT ["/opt/spark/bin/spark-submit", "--packages", "org.apache.hadoop:hadoop-aws:2.7.3,com.amazonaws:aws-java-sdk:1.7.4", "Wine_Quality_Prediction.py"]
